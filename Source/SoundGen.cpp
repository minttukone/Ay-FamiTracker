...
void CSoundGen::CreateChannels()
{
	...
	// // // Sunsoft 5B
	AssignChannel(new CTrackerChannel(_T("AY Square 1"), _T("5B1"), SNDCHIP_S5B, CHANID_S5B_CH1));
	AssignChannel(new CTrackerChannel(_T("AY Square 2"), _T("5B2"), SNDCHIP_S5B, CHANID_S5B_CH2));
	AssignChannel(new CTrackerChannel(_T("AY Square 3"), _T("5B3"), SNDCHIP_S5B, CHANID_S5B_CH3));
}
